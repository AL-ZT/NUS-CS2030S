...
class Probably<T> implements Actionable<T>, Immutatorable<T>, Applicable<T> {
  ...
  @Override 
  public <R> Probably<R> transform(Immutator<? extends R, ? super T> imm) {
    if (value != null) {
      return Probably.<R>just(imm.invoke(value));
    }
    return Probably.<R>none();
  }

  public Probably<T> check(Immutator<Boolean, ? super T> isMod) {
    if (value != null) {
      if (isMod.invoke(value)) {
        return this;
      }
      return none();
    }
  ...
  @Override
  public <R> Probably<R> apply(Probably<? extends Immutator<? extends R, ? super T>> prob) {
    if (this.value != null) {
      if (prob.value != null) {
        return this.transform(prob.value);
      }
      return none();
    }
    return Probably.<R>none();
