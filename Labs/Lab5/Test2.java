...
public class Test2 {
  public static void main(String[] args) {
    ...
    final cs2030s.fp.Constant<Integer> zero = new cs2030s.fp.Constant<>() {
      public Integer init() {
        return 0;
      }
    };
    final cs2030s.fp.Action<Integer> print = new cs2030s.fp.Action<>() {
    ...
    we.expect(
        ...
        cs2030s.fp.Actually.<Number>err(
