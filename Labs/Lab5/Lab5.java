...
class Lab5 {
  public static String getGrade(String module, String student, String assessment,
    ...
    Constant<String> noEntry = new Constant<>() {
      @Override
      public String init() {
    ...
    Constant<Actually<Map<String, Map<String, Map<String, String>>>>> wrapDb = new Constant<>() {
      @Override
    ...
    Immutator<Actually<Map<String, Map<String, String>>>, 
        Map<String, Map<String, Map<String, String>>>> getModule = new Immutator<>() {
          ...
          public Actually<Map<String, Map<String, String>>> 
              invoke(Map<String, Map<String, Map<String, String>>> m) {
    ...
    return wrapDb.init().next(getModule).next(getStudent).next(getAssessment).except(noEntry);
  ...
  public static void test1() {
    ...
    System.out.println(Actually.err(
        new ArithmeticException("Err")).equals(Actually.err(new Exception("Err"))));
    System.out.println(Actually.err(
        new ArithmeticException("Err")).equals(Actually.err(new Exception("Error"))));
    System.out.println(Actually.err(
        new ArithmeticException("Err")).equals(Actually.err(new Exception(none))));
    System.out.println(Actually.err(
        new ArithmeticException(none)).equals(Actually.err(new Exception(none))));
    System.out.println(Actually.err(
        new ArithmeticException("Err")).equals(Actually.ok("Err")));
    System.out.println(Actually.ok("Err").equals(Actually.ok("Err")));
    System.out.println(Actually.ok(
        "Err").equals(Actually.err(new Exception("Error"))));
  ...
  public static void test2() {
    ...
    System.out.println(Actually.<Number>err(
        new ArithmeticException("div by 0")).except(zero).toString());
    System.out.println(Actually.<Number>err(
        new ArithmeticException("div by 0")).unless(4).toString());
