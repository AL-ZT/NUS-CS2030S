...
public class Test0 {
  public static void main(String[] args) {
    ...
    we.expectCompile("Actually<Object> div0 = " + 
        "Actually.err(new ArithmeticException(\"Divide by 0\")) should compile",
        "cs2030s.fp.Actually<Object> div0 = " + 
        "cs2030s.fp.Actually.err(new ArithmeticException(\"Divide by 0\"));", true);
  }
}
