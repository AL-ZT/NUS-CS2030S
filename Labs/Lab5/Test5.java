...
public class Test5 {
  public static void main(String[] args) {
    ...
    cs2030s.fp.Immutator<cs2030s.fp.Actually<Integer>, Integer> half = 
        new cs2030s.fp.Immutator<>() {
    ...
    cs2030s.fp.Immutator<cs2030s.fp.Actually<Integer>, Integer> inc = 
        new cs2030s.fp.Immutator<>() {
          public cs2030s.fp.Actually<Integer> invoke(Integer p) {
            return cs2030s.fp.Actually.<Integer>ok(p + 1);
          }
        };
    cs2030s.fp.Immutator<cs2030s.fp.Actually<Integer>, Integer> make =
        new cs2030s.fp.Immutator<>() {
          public cs2030s.fp.Actually<Integer> invoke(Integer p) {
